...
<head>
  ...
  <title> گزارش تجهیزات دادگستری خمین</title>
...
<body>
      ...
      <main>
            <div class="container-fluid">
              <div class="center mb-2 tittle_header">
                ...
                <h5 class="mr-15">دادگستری خمین</h5>
            </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                        <div class="col-6">
                            <!--pc start-->
                                    ...
                                    $get_data = "SELECT moth_model, ram_model, hard_model, COUNT(*) as total_count
                                                FROM tb_hardware
                                                WHERE city_name = 'دادگستری آشتیان'
                        ...
                        <div class="col-6">
                            ...
                            <div class="col-12">
                                    ...
                                    $get_data = "SELECT printer_model, COUNT(*) as total_count
                                                FROM tb_hardware
                                                WHERE city_name = 'دادگستری خمین' AND printer_model != 'ندارد'
    ...
    $get_data = "SELECT scaner_model, COUNT(*) as total_count
                 FROM tb_hardware
                 WHERE city_name = 'دادگستری خمین' AND scaner_model != 'ندارد'
