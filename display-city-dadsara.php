...
<title> گزارش  مجتمع دادسرای اراک </title>
...
include 'db.php';
      ...
      $get_data = "SELECT * FROM tb_hardware WHERE city_name = 'دادسرای اراک '";
  ...
  <header>
    ...
    while ($array_data = $get_data_query->fetch_assoc()) { ?>
        <tr>
            ...
            <td><?php echo $array_data['user_id'] ?></td>
            <td><?php echo $array_data['user_job'] ?></td>
            <td><?php echo $array_data['system_id'] ?></td>
            <td><?php echo $array_data['system_model'] ?></td>
            <td><?php echo $array_data['monitor_id'] ?></td>
            <td><?php echo $array_data['monitor_model'] ?></td>
            <td><?php echo $array_data['printer_id'] ?></td>
            <td><?php echo $array_data['printer_model'] ?></td>
            <td><?php echo $array_data['scaner_id'] ?></td>
