        ...
        <div class="row">
          <div class="col-md-4">
                <ul class="list-unstyled" id="report-type">
                    ...
                    <li><a href="display-device-city-model-printer.php"><h6>گزارش مدل پرینتر و تعداد بر اساس هر مجتمع </h6></a></li>
                    <li><a href="display-device-city-model-monitor.php"><h6>گزارش مدل مانیتور و تعداد بر اساس هر مجتمع </h6></a></li>
