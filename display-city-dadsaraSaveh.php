...
<head>
  ...
  <title> گزارش تجهیزات دادسرای ساوه</title>
...
<body>
      ...
      <main>
            <div class="container-fluid">
              <div class="center mb-2 tittle_header">
                ...
                <h5 class="mr-15">دادسرای ساوه</h5>
            </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="col-12">
                                    ...
                                    $get_data = "SELECT printer_model, COUNT(*) as total_count
                                                FROM tb_hardware
                                                WHERE city_name = 'دادسرای ساوه' AND printer_model != 'ندارد'
    ...
    $get_data = "SELECT scaner_model, COUNT(*) as total_count
                 FROM tb_hardware
                 WHERE city_name = 'دادسرای ساوه' AND scaner_model != 'ندارد'
